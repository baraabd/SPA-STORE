...
run = function() {
	...
	var errfunc = function(e){
		var apa = "Output <i style='color:red; background-color:red;' >M mmmmmmmmmmmmmmmmmmm</i> ";
		document.querySelector('#debug-bar-console-output strong').innerHTML = apa;
	...
	$.post( ajaxurl, {
		...
		nonce:  nonce,
				...
				var apa = "Output <i style='color:green; background-color:green;' >M </i> ";
		document.querySelector('#debug-bar-console-output strong').innerHTML = apa;
